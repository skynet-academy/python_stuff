...
def usage():
    ...
    print("bhpnet.py -t 192.168.0.1 -p 5555 -l -u=/home/sky-net/Documents/target.exe")
...
def client_handler(client_socket):
    ...
    if len(upload_destination):
        ...
        #keep reading data until none is avaible 
...
def run_command(command):
    ...
    # sned the output back to the client
...
def main():
    ...
    # we are going to listen and potentialy
